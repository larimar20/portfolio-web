...
export const projectDetails: Record<string, ProjectDetail> = {
  wava: {
    ...
    description: [
      ...
      "El proyecto comenzó con una fase de investigación para comprender el problema y definir un User Persona, que guio todas las decisiones de diseño. A partir de ahí, se desarrollaron la arquitectura de la información, los user flows y los primeros wireframes, priorizando una navegación sencilla e intuitiva.",
  ...
  kankyo: {
    ...
    gallery: [
      ...
      },
      {
        ...
        video: { src: "/images/kankyovideotv.mov", alt: "Demo Kankyo karaoke" },
